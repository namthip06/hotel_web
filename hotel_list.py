...
#Dusit Thani Pattaya
myHotel.hotel[0].imgsrc.extend(["https://lh5.googleusercontent.com/p/AF1QipPsybvTkTY_3x8JlX_q-4TzKXLrpubv7lkl1wGg=w203-h135-k-no",
...
#The Dorchester
myHotel.hotel[8].imgsrc.extend(["https://media.tatler.com/photos/64491d544b0c1dd744840940/4:3/w_5976,h_4482,c_limit/JS308250%20(1).jpg",
...
myHotel.hotel[13].imgsrc.extend(["https://www.familyvacationcritic.com/wp-content/webp-express/webp-images/doc-root/wp-content/uploads/sites/19/2014/08/hotel-eden.jpg.webp",
...
myHotel.hotel[18].imgsrc.extend(["https://media-cdn.tripadvisor.com/media/photo-s/24/ff/6e/da/exterior.jpg",
...
myHotel.hotel[23].imgsrc.extend(["https://x.cdrst.com/foto/hotel-sf/1839c/granderesp/hilton-niseko-village-general-c175fb1.jpg",
...
myHotel.hotel[34].imgsrc.extend(["https://cf.bstatic.com/xdata/images/hotel/max1024x768/55548003.jpg?k=c081c488394520e2b07413f18929ee45a005e0b407c0213c99634da2cfc504c2&o=&hp=1",
...
for hotel in myHotel.hotel:
        ...
        hotel.room = main.Room("Suite", 6000, 5)
        hotel.room = main.Room("Honeymoon", 30000, 2)
        hotel.room = main.Room("Family", 7500, 4)
        hotel.room = main.Room("Lover Room", 10000, 2)
        hotel.room = main.Room("Business Room", 25000, 2)
        ...
        hotel.room = main.Room("Superior Room", 12000, 2)
        hotel.room = main.Room("Standard Room", 10000, 1)
        hotel.room = main.Room("Economy Room", 8000, 1)
        hotel.room = main.Room("Budget Room", 5000, 1)

# myHotel.hotel[0].room[0].discount = main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 1, 1), datetime.date(2023, 1, 15))
# myHotel.hotel[0].room[3].discount = main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 6), datetime.date(2023, 1, 8))
# myHotel.hotel[3].room[1].discount = main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 1, 4), datetime.date(2023, 1, 7))
# myHotel.hotel[3].room[0].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 2, 14), datetime.date( 2023, 2, 28))
# myHotel.hotel[6].room[15].discount = main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 3, 10), datetime.date(2023, 3, 24))
# myHotel.hotel[6].room[11].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 4, 6), datetime.date( 2023, 4, 19))
# myHotel.hotel[9].room[0].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 5, 2), datetime.date(2023, 5, 16))
# myHotel.hotel[9].room[7].discount = main.Discount("LETSPARTY", 0.2, datetime.date(2023, 6, 8), datetime.date(2023, 6, 21))
# myHotel.hotel[12].room[9].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 1, 1), datetime.date(2023, 1, 5))
# myHotel.hotel[12].room[0].discount = main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 6), datetime.date(2023, 1, 8))
# myHotel.hotel[15].room[10].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 7, 3), datetime.date(2023, 7, 17))
# myHotel.hotel[15].room[14].discount = main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 8), datetime.date(2023, 1, 10))
# myHotel.hotel[18].room[2].discount = main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 8, 21), datetime.date(2023, 9, 4))
# myHotel.hotel[18].room[8].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 11, 7), datetime.date(2023, 11, 20))
# myHotel.hotel[21].room[11].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 1, 24), datetime.date(2023, 2, 6))
# myHotel.hotel[21].room[9].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 2, 17), datetime.date(2023, 3, 3))
# myHotel.hotel[24].room[12].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 3, 30), datetime.date(2023, 4, 12))
# myHotel.hotel[49].room[15].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 7, 29), datetime.date(2023, 8, 11))
# myHotel.hotel[27].room[1].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 10, 28), datetime.date(2023, 11, 10))
# myHotel.hotel[27].room[3].discount = main.Discount("LETSPARTY", 0.2, datetime.date(2023, 12, 7,), datetime.date(2023, 12, 21))
# myHotel.hotel[30].room[4].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 1, 1), datetime.date(2023, 1, 5))
# myHotel.hotel[30].room[0].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 1, 6), datetime.date(2023, 1, 8))
# myHotel.hotel[33].room[1].discount = main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 1, 4), datetime.date(2023, 1, 7))
# myHotel.hotel[33].room[0].discount = main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 2, 14), datetime.date( 2023, 2, 28))
# myHotel.hotel[36].room[15].discount = main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 3, 10), datetime.date(2023, 3, 24))
        
myHotel.hotel[0].room[0].add_discount(main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 1, 15)))
myHotel.hotel[0].room[3].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 8)))
myHotel.hotel[3].room[1].add_discount(main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 1, 7)))
myHotel.hotel[3].room[0].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date( 2023, 2, 28)))
myHotel.hotel[6].room[15].add_discount(main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 3, 24)))
myHotel.hotel[6].room[11].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date( 2023, 4, 19)))
myHotel.hotel[9].room[0].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 5, 16)))
myHotel.hotel[9].room[7].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 6, 21)))
myHotel.hotel[12].room[9].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 1, 5)))
myHotel.hotel[12].room[0].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 8)))
myHotel.hotel[15].room[10].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 7, 17)))
myHotel.hotel[15].room[14].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 10)))
myHotel.hotel[18].room[2].add_discount(main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 9, 4)))
myHotel.hotel[18].room[8].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 11, 20)))
myHotel.hotel[21].room[11].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 2, 6)))
myHotel.hotel[21].room[9].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 3, 3)))
myHotel.hotel[24].room[12].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 4, 12)))
myHotel.hotel[49].room[15].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 8, 11)))
myHotel.hotel[27].room[1].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 11, 10)))
myHotel.hotel[27].room[3].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 12, 21)))
myHotel.hotel[30].room[4].add_discount(main.Discount("HAPPYHOLIDAY", 0.3, datetime.date(2023, 1, 5)))
myHotel.hotel[30].room[0].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 1, 8)))
myHotel.hotel[33].room[1].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 1, 7)))
myHotel.hotel[33].room[0].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date( 2023, 2, 28)))
myHotel.hotel[36].room[15].add_discount(main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 3, 24)))
myHotel.hotel[36].room[11].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date( 2023, 4, 19)))
myHotel.hotel[39].room[0].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 5, 16)))
myHotel.hotel[39].room[7].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 6, 21)))
myHotel.hotel[42].room[9].add_discount(main.Discount("HAPPYHOLIDAY", 0.3, datetime.date(2023, 1, 5)))
myHotel.hotel[42].room[0].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 8)))
myHotel.hotel[45].room[10].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 7, 17)))
myHotel.hotel[45].room[14].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 1, 10)))
myHotel.hotel[48].room[2].add_discount(main.Discount("SUMMERVACATION", 0.1, datetime.date(2023, 9, 4)))
myHotel.hotel[48].room[8].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 11, 20)))
myHotel.hotel[49].room[11].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 2, 6)))
myHotel.hotel[49].room[9].add_discount(main.Discount("SWEETLOVE", 0.3, datetime.date(2023, 3, 3)))
myHotel.hotel[0].room[12].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 4, 12)))
myHotel.hotel[0].room[8].add_discount(main.Discount("SWEETLOVE", 0.2, datetime.date(2023, 8, 11)))
myHotel.hotel[3].room[11].add_discount(main.Discount("HAPPYHOLIDAY", 0.1, datetime.date(2023, 11, 10)))
myHotel.hotel[3].room[9].add_discount(main.Discount("LETSPARTY", 0.2, datetime.date(2023, 12, 21)))
...
myHotel.hotel[0].room[0].reservation = main.Reservation("Kaito Yamamoto", datetime.date(2023, 1, 1), datetime.date(2023, 1, 5))
...
# myHotel.hotel[0].room[0].add_discount(0.1, datetime.date(2023, 1, 1), datetime.date(2023, 1, 5))
