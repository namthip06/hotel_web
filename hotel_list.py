...
myHotel.hotel[0].room[0].discount = main.Discount("SUMMERVACATION", 0.9, datetime.date(2023, 1, 1), datetime.date(2023, 1, 15))
myHotel.hotel[0].room[3].discount = main.Discount("LETSPARTY", 0.8, datetime.date(2023, 1, 6), datetime.date(2023, 1, 8))
myHotel.hotel[3].room[1].discount = main.Discount("SUMMERVACATION", 0.9, datetime.date(2023, 1, 4), datetime.date(2023, 1, 7))
myHotel.hotel[3].room[0].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 2, 14), datetime.date( 2023, 2, 28))
myHotel.hotel[6].room[15].discount = main.Discount("SUMMERVACATION", 0.9, datetime.date(2023, 3, 10), datetime.date(2023, 3, 24))
myHotel.hotel[6].room[11].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 4, 6), datetime.date( 2023, 4, 19))
myHotel.hotel[9].room[0].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 5, 2), datetime.date(2023, 5, 16))
myHotel.hotel[9].room[7].discount = main.Discount("LETSPARTY", 0.8, datetime.date(2023, 6, 8), datetime.date(2023, 6, 21))
myHotel.hotel[12].room[9].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 1, 1), datetime.date(2023, 1, 5))
myHotel.hotel[12].room[0].discount = main.Discount("LETSPARTY", 0.8, datetime.date(2023, 1, 6), datetime.date(2023, 1, 8))
myHotel.hotel[15].room[10].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 7, 3), datetime.date(2023, 7, 17))
myHotel.hotel[15].room[14].discount = main.Discount("LETSPARTY", 0.8, datetime.date(2023, 1, 8), datetime.date(2023, 1, 10))
myHotel.hotel[18].room[2].discount = main.Discount("SUMMERVACATION", 0.9, datetime.date(2023, 8, 21), datetime.date(2023, 9, 4))
myHotel.hotel[18].room[8].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 11, 7), datetime.date(2023, 11, 20))
myHotel.hotel[21].room[11].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 1, 24), datetime.date(2023, 2, 6))
myHotel.hotel[21].room[9].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 2, 17), datetime.date(2023, 3, 3))
myHotel.hotel[24].room[12].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 3, 30), datetime.date(2023, 4, 12))
myHotel.hotel[49].room[15].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 7, 29), datetime.date(2023, 8, 11))
myHotel.hotel[27].room[1].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 10, 28), datetime.date(2023, 11, 10))
myHotel.hotel[27].room[3].discount = main.Discount("LETSPARTY", 0.8, datetime.date(2023, 12, 7,), datetime.date(2023, 12, 21))
myHotel.hotel[30].room[4].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 1, 1), datetime.date(2023, 1, 5))
myHotel.hotel[30].room[0].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 1, 6), datetime.date(2023, 1, 8))
myHotel.hotel[33].room[1].discount = main.Discount("HAPPYHOLIDAY", 0.9, datetime.date(2023, 1, 4), datetime.date(2023, 1, 7))
myHotel.hotel[33].room[0].discount = main.Discount("SWEETLOVE", 0.8, datetime.date(2023, 2, 14), datetime.date( 2023, 2, 28))
myHotel.hotel[36].room[15].discount = main.Discount("SUMMERVACATION", 0.9, datetime.date(2023, 3, 10), datetime.date(2023, 3, 24))
